    ...
    <section className="relative bg-black py-24 text-center z-10 m-w-[90%]">
      <div className="w-full m-auto flex flex-col items-center gap-16">
        <div className="text-center w-full flex flex-col items-center">
          <span className="text-golden text-lg font-bold tracking-widest">ISKUSTVO</span>
          <h2 className="text-white uppercase text-5xl font-black text-center tracking-wider m-0 mb-8">Zasto Izabrati nas?</h2>
          <p className="text-opacity-80 text-white leading-6 max-w-2xl m-0 text-lg">Stojimo iza našeg rada sa garancijom od 100% kvaliteta izvedenih radova i ako imate bilo kakve brige ili probleme sa bilo kojim delom završenog posla, osiguraćemo da budu rešeni i otklonjeni. Naš cilj broj 1 je da svakog klijenta ostavimo zadovoljnim i 100% srećnim sa našim radom. Ako tražite izvođača za moleraj, gletovanje, farbanje i krečenje koji će posao obaviti kako treba već prvi put, ne tražite dalje!</p>
        </div>
        <ul className="flex flex-row justify-center flex-wrap items-stretch m-0 p-0 text-white max-w-full gap-x-10 gap-y-15">
          <li className="w-1/4 max-w-sm">
            ...
            <p className="text-base m-0">Naš prioritet je da se pobrinemo da imate besprekorno iskustvo od početka do kraja i da volite izgled vašeg doma 100%.</p>
          </li>
          <li className="w-1/4 max-w-sm">
            <div className="w-24 h-24 m-auto mb-6 bg-white flex items-center justify-center">
            ...
            <p className="text-base m-0">Garantujemo da ćete biti zadovoljni našim radom i pobrinućemo se da svi poslovi budu pažljivo pregledani dva puta nakon završetka.</p>
          </li>
          <li className="w-1/4 max-w-sm">
            <div className="w-24 h-24 m-auto mb-6 bg-white flex items-center justify-center">
            ...
            <p className="text-base m-0">Znamo tačno koliko treba da ponudimo za svaki posao i odbijamo da precenjujemo ili povecavamo te troškove, pružajući i dalje najviši kvalitet izvedenih radova.</p>
          </li>
        </ul>
      </div>
